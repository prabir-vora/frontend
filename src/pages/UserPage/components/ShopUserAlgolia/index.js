...
import AlgoliaProduceTemplate from './components/AlgoliaProductTemplate';
...
export default class ShopUserAlgolia extends Component {
        ...
        >
          ...
          <div className={Style.filterContentArea}>
            ...
            >
              ...
              <Configure
                hitsPerPage={9}
                filters={`productCategory:${this.state.productCategory} AND reseller_username:${this.props.reseller_username}`}
              />
            </div>
